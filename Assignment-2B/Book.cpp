...
#include "LibraryItem.h"   // Include the LibraryItem class
using namespace std;
...
public:
    // Default constructor
    Book() : ID(0), book_id(0), isbn(0), title(""), authors(""), original_publication_year(0), borrowed(false) {}

    // Parametrized constructor
    explicit Book(int ID, int book_id, int isbn, const string &title, const string &authors, int original_publication_year)
    ...
    void setAuthors(const string &newAuthor) { authors = newAuthor; }
